  ...
  sidebarLayout(
    ...
    mainPanel(
      tabsetPanel(type = "pills",
                  ...
                  tabPanel("2018 Update",list(plotlyOutput("classPlot2018"), tableOutput("table.out"))),
           
                  tabPanel("2015 Update", plotOutput("ccPlot"), tableOutput("table.out15"))
...
server <- function(input, output,session) {
  ...
  output$classPlot2018 <- renderPlotly({
  ...
  # 2015 Carnegie Classifications Version of this
  ...
  ## table of current values (2018)
  output$table.out15 <- renderTable({
